...
from util import read_text, get_prime_number, open_keyb, open_keya, message_RSA, name_choise
from RSA import RSA, RSA_Formula
...
class Window_1(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle('RSA(number)')
        ...
        self.m = message_RSA(self.p1, self.p2)
        self.name, self.index = name_choise()           #выбор рандомного имени в задании
        self.e_B, self.d_B, self.e_A, self.d_A = RSA(self.p1, self.p2, self.q1, self.q2, self.open_key_A, self.open_key_B, self.m)
    ...
    def click_btn_ex(self):
        try:
            ...
            self.outp_ex.setHtml(f"<font style='font-family: Arial; font-size: 12pt;'>{RSA_Formula(v_exmpl_p1, v_exmpl_p2, v_exmpl_q1, v_exmpl_q2, v_exmpl_oA, v_exmpl_oB, v_exmpl_m)}")
